        ...
        for (ParticipantDto dto : dtos) {
            ...
            participants.add(
                    Participant.builder()
                            ...
                            .damageRate(dto.challenges().getTeamDamagePercentage().intValue() * 100)
                            .gainDamage(dto.totalDamageTaken())
                            .heal(dto.totalHeal())
                            .earnedGold(dto.goldEarned())
                            .spentGold(dto.goldSpent())
                            .visionScore(dto.visionWardsBoughtInGame())
                            .sightWard(dto.sightWardsBoughtInGame())
                            ...
                            .subPerkStyle(subPerk.get(1).perk())
